...
import police from '../assets/picture/police.png';
import dil from '../assets/picture/dil.png';
...
const Page4 = () => {
  ...
  return (
    <motion.div className="container">
      <div className="page4_cnt">
      <div className="svgspan">
          <span>The Next Big</span>
          <h1>Blockchain</h1>
          <span className="spanright">Revolution</span>
        </div>
        <div className="svgbox4">
        <svg version="1.1" id="transring" xmlns="http://www.w3.org/2000/svg"
          ...
          {inView && ( <path id="Opaque_Ring" className="transrgwht4" strokeDasharray="0,1000"
            style={{ opacity:1,fill: 'none', stroke: 'rgb(255, 255, 255)', strokeWidth: 2, strokeMiterlimit: 10, strokeDasharray: '280, 1000' }}
            d="M84.2,85c31.3-31.5,74.7-51,122.7-51c95.5,0,173,77.5,173,173s-77.5,173-173,173 c-47.8,0-91-19.4-122.3-50.7"></path>)}
      ...
      <div ref={ref} className="animatepage4">
        {inView && (
          <>
            <motion.div
              initial={{ y: 100 }}
              ...
              className="animatepageimg41"
            >
              <img src={dil} alt="dress" />
            </motion.div>
            <motion.div
              initial={{ y: 100 }}
              animate={{ y: 0 }}
              transition={{duration: 1,dealy:0.6}}
              className="animateimage42"
            >
              <img src={police} alt="dress" />
            </motion.div>
          </>
        )}
      </div>
