...
import remix from '../assets/picture/remix.png';
import veme from '../assets/picture/veme.png';
...
const Page5 = () => {
  ...
  return (
    <motion.div className="container">
      <div className="page5_cnt">
      <div className="svgspan">
          <h1>25M+ Downloads</h1>
          <span>an appstore &google playstore</span>
        </div>
        <div className="svgbox5">
        <svg version="1.1" id="transring" xmlns="http://www.w3.org/2000/svg"
          ...
          {inView && ( <path id="Opaque_Ring" className="transrgwht5" strokeDasharray="0,1000"
            style={{opacity:1, fill: 'none', stroke: 'rgb(255, 255, 255)', strokeWidth: 2, strokeMiterlimit: 10, strokeDasharray: '410, 1000' }}
            d="M84.2,85c31.3-31.5,74.7-51,122.7-51c95.5,0,173,77.5,173,173s-77.5,173-173,173 c-47.8,0-91-19.4-122.3-50.7"></path>)}
      ...
      <div ref={ref} className="animatepage5">
        {inView && (
          <>
            <motion.div
              initial={{ y: 100 }}
              ...
              className="animatepageimg51"
            >
              <img src={remix} alt="dress" />
            </motion.div>
            <motion.div
              initial={{ y: -200 }}
              animate={{ y: 0 }}
              transition={{duration:0.7,dealy:1}}
              className="animateimage52"
            >
              <img src={veme} alt="dress" />
            </motion.div>
          </>
        )}
      </div>
